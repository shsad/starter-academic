...
image:
  ...
  caption: "Targeted adversarial examples generated by GSE. The target is \q{airship} for the first two rows, and \q{golf cart} for the last two rows. See article for details."
  focal_point: ""
  preview_only: false
